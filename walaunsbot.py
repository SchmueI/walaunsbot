"""
WALAUNSBOT v2.0 by @Schmuel

Walaunsbot gives daily updates about the 🅆🄰ter level measured in 🄻🄰ucha at the 🅄🄽🅂trut.
This bot is a present for the author's co-worker Sandra. Version 1.0 was tested and released in June 2021.
...
Walaunsbot v2.0 is powered by telebot from pyTelegramBotAPI.
https://pypi.org/project/pyTelegramBotAPI/

Walaunsbot v1.0 used the outdated version of Telepot:
...
def getWaterLevel():
	url = 'https://hochwasservorhersage.sachsen-anhalt.de/fileadmin/Bibliothek/Politik_und_Verwaltung/MLU/HVZ/KISTERS/data/internet/stations/LHW/573360/W/week.json'
